...
import {
  ...
  FaChevronDown, FaChevronUp, FaGift, FaCalendarAlt,
  FaMoneyBill, FaPrint
} from "react-icons/fa";
...
const SchemeReportPage: React.FC = () => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-2 rounded-lg shadow-md">
            <h1 className="text-white font-bold text-lg flex items-center gap-2">
              <FaUsers /> {report.offer_name} — Report
            </h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-sm capitalize">{report.scheme_type?.replace("_", " ")}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
